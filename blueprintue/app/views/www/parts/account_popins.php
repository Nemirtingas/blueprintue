            ...
            <div class="popin__container">
                <div class="popin__body">
                    <div class="popin__header">
                        <h2 class="popin__title" id="popin-login-h2">Log in to <span class="popin__title--span"><?php echo Security::escHTML(Application::getConfig()->get('SITE_NAME', 'blueprintUE')); ?></span></h2>
                    </div>
                ...
                <div class="popin__body popin__body--bottom popin__body--bg-grey">
                    <p>New to <?php echo Security::escHTML(Application::getConfig()->get('SITE_NAME', 'blueprintUE')); ?>? <a class="popin__link" href="#popin-register">Create your account</a></p>
                </div>
    ...
    <div aria-labelledby="popin-register-h2" class="popin" id="popin-register" role="dialog">
        <div class="popin__mask">
            ...
            <div class="popin__container">
                <div class="popin__body">
                    <div class="popin__header">
                        <h2 class="popin__title" id="popin-register-h2">Join <span class="popin__title--span"><?php echo Security::escHTML(Application::getConfig()->get('SITE_NAME', 'blueprintUE')); ?></span></h2>
