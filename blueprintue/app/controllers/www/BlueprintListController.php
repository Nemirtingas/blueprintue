...
class BlueprintListController implements MiddlewareInterface
{
    ...
    protected function treatRouteSearch(ServerRequestInterface $request): bool
    {
        ...
        if (isset($queryParams['form-search-select-type']) && \in_array($queryParams['form-search-select-type'], ['animation', 'behavior-tree', 'blueprint', 'material', 'metasound'], true)) { // phpcs:ignore
